              ...
              <div className="space-y-6 -mt-36">
                <div>
                  ...
                  <p className="text-lg text-gray-600">
                    Secure, fast, and reliable messaging for modern teams. 
                    Join thousands of users already collaborating seamlessly.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Instant delivery and notifications</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Organize conversations with channels and groups</p>
                    </div>
                  </div>
                </div>

                <div className="bg-white/60 backdrop-blur-sm border border-white/20 rounded-lg p-4">
                  <div className="flex items-center space-x-4">
                    <div className="flex -space-x-2">
                      ...
                      <div className="w-8 h-8 bg-gradient-to-r from-pink-400 to-pink-600 rounded-full border-2 border-white flex items-center justify-center">
                        <span className="text-xs font-semibold text-white">+5</span>
                      </div>
                    </div>
                    <div>
                      <p className="text-sm font-semibold text-gray-900">Join 10,000+ users</p>
                      <p className="text-xs text-gray-600">Already using ChatApp</p>
                    </div>
                  </div>
                </div>
              </div>
