          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              {[
                {
                  quote:
                    "Techonsy has transformed how we manage our projects. The automation features have saved us countless hours of manual work.",
                ...
                {
                  quote:
                    "We've tried several similar solutions, but none compare to the ease of use and comprehensive features of Techonsy. It's been a game-changer.",
                  author: "David Kim",
                ...
                {
                  quote:
                    "Implementation was seamless, and the ROI was almost immediate. We've reduced our operational costs by 30% since switching to Techonsy.",
                  author: "James Wilson",
        ...
        <div className="container flex flex-col gap-8 px-4 py-10 md:px-6 lg:py-16">
          ...
          <div className="flex flex-col gap-4 sm:flex-row justify-between items-center border-t border-border/40 pt-8">
            <p className="text-xs text-muted-foreground">
              &copy; {new Date().getFullYear()} Techonsy. All rights reserved.
            </p>
            <div className="flex gap-4">
